...
model1 = spls.adapt(Xtrain=X, Ytrain=Y, lambda.l1=0.5, ncomp=2, weight.mat=NULL, Xtest=NULL, adapt=TRUE, center.X=TRUE, center.Y=TRUE, scale.X=TRUE, scale.Y=TRUE, weighted.center=FALSE)
...
model2 = spls.adapt(Xtrain=X[1:80,], Ytrain=Y[1:80,], lambda.l1=0.5, ncomp=2, weight.mat=NULL, Xtest=X[81:100,], adapt=TRUE, center.X=TRUE, center.Y=TRUE, scale.X=TRUE, scale.Y=TRUE, weighted.center=FALSE)
...
model3 = spls.adapt(Xtrain=X[1:80,], Ytrain=Y[1:80,], lambda.l1=0.5, ncomp=2, weight.mat=diag(1, nrow=80, ncol=80), Xtest=X[81:100,], adapt=TRUE, center.X=TRUE, center.Y=TRUE, scale.X=TRUE, scale.Y=TRUE, weighted.center=FALSE)
